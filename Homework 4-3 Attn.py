...
# Dataset - reversed from English->French to French->English
french_to_english = [
...
# Maximum length for the attention mechanism
max_length = 100
...
def train(input_tensor, target_tensor, encoder, decoder, 
          encoder_optimizer, decoder_optimizer, criterion, max_length=100):
...
def calculate_validation_loss(encoder, decoder, dataloader, criterion, max_length=100):
    encoder.eval()
    decoder.eval()
    total_loss = 0
